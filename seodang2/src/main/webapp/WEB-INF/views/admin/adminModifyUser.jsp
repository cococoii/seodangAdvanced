...
<div class="page-main">
	...
	<div class="order_form8">
		<div style="text-align:center">
			<c:if test="${!empty userVO.photo_name}">
		   		<img src="${pageContext.request.contextPath}/admin/photoView.do?user_num=${userVO.user_num}" 
		   	                        class="my-photo" style="width:300px; height:300px;">
		   	</c:if>
		   	<c:if test="${empty userVO.photo_name}">
		...
		<form:form modelAttribute="userVO" action="adminUpdateUser.do" class="order_form7">
			...
			<div class="align-center">
				<input type="button" value="회원목록" class="listbtn2" onclick="locaion.href='adminMemberList.do'">
				<form:button class="listbtn2">수정</form:button>
			</div>	
		</form:form>
	</div>
